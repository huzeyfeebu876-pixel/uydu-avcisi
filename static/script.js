...
// Initialize map
var map = L.map('map').setView([39.9334, 32.8597], 6); // Default center: Turkey
...
function updateCoordinatesInfo(layer) {
    ...
    var areaText = L.GeometryUtil.readableArea(area, true);
    html += `<br><strong>Tahmini Alan:</strong> ${areaText}`;
